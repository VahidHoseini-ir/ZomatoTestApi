...
public class MainResturantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public MainResturantViewHolder(@NonNull View itemView, OnClickListener onResturantListener) {
        super(itemView);
